...
export const successColor = '#3e9f40';
...
// Placeholder
export const placeholderTextColor = '#b9b9b9';
export const placeholderLineHeight = '1.14';
export const placeholderFontWeight = '500';
export const placeholderFontSize = '14px';

// Facebook Button
export const fbBtnColor = '#3674bc';
export const fbBtnHoverColor = '#2d5d93';
